  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section
          id="hero"
          className="relative flex min-h-screen items-center justify-center text-center overflow-hidden bg-cover bg-center bg-no-repeat px-4 py-24"
          style={{
          ...
          <div className="relative z-10 mx-auto max-w-3xl px-4 flex flex-col items-center justify-center gap-6 text-white">
            ...
            <div className="mt-4 grid gap-4 text-xs sm:grid-cols-3 sm:text-sm">
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-3 py-3">
                <div className="flex h-9 w-9 p-2 items-center justify-center rounded-full bg-(--secondary) text-(--primary)">
                  <Droplets size={18} />
                </div>
              ...
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-3 py-3">
                <div className="flex h-9 w-9 p-2 items-center justify-center rounded-full bg-white text-(--primary)">
                  <Sparkles size={18} />
                </div>
                <div className="flex flex-col self-start">
