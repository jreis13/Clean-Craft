  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section
          id="hero"
          className="relative flex min-h-[85vh] items-center overflow-hidden bg-linear-to-b from-(--primary) to-(--skyBlue) py-24 text-white"
        >
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] lg:px-8">
            <div className="space-y-6">
              <span className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-(--secondary)">
              ...
              <div className="mt-4 grid gap-4 text-xs sm:grid-cols-3 sm:text-sm">
                <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-3 py-3">
                  <div className="flex h-9 w-9 p-2 items-center justify-center self-center rounded-full bg-(--secondary) text-(--primary)">
                    <Droplets size={18} />
                  </div>
                ...
                <div className="flex items-center gap-3 rounded-2xl bg-white/10 px-3 py-3">
                  <div className="flex h-9 w-9 p-2 items-center justify-center self-center rounded-full bg-white text-(--primary)">
                    <Sparkles size={18} />
                  </div>
                  <div className="flex flex-col self-start">
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-2xl bg-white shadow-xl">
                <div className="relative aspect-4/3 w-full">
                  <Image
                    ...
                    priority
                  />
                  <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-[rgba(0,95,115,0.4)] via-[rgba(0,95,115,0.1)] to-transparent" />
                </div>
              ...
              <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-(--secondary) opacity-40 blur-3xl" />
