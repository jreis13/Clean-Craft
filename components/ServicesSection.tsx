...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="w-full py-24 bg-(--skyBlue) text-(--deep)"
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
          <div className="rounded-2xl bg-white/90 p-6 shadow-md backdrop-blur-sm flex flex-col gap-3">
            <div className="h-10 w-10 rounded-full bg-(--secondary) flex items-center justify-center text-(--primary) mx-auto">
              <House size={20} />
            </div>
            <h3 className="font-semibold text-center text-(--deep)">
              Fachadas
            </h3>
          ...
          <div className="rounded-2xl bg-white/90 p-6 shadow-md backdrop-blur-sm flex flex-col gap-3">
            ...
            <h3 className="font-semibold text-center text-(--deep)">Pátios</h3>
            <p className="text-sm text-center text-(--deep)/70">
