...
export default function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      className="w-full pt-20 pb-24 bg-(--skyBlue) text-(--deep)"
    >
      <div className="max-w-6xl mx-auto px-4 flex flex-col gap-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-3 text-white">
            Cada etapa explicada ao detalhe
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-8 items-center">
          <div className="lg:w-3/5">
            <div className="relative h-full min-h-[360px] overflow-hidden rounded-3xl bg-white shadow-xl">
              <div className="absolute -right-24 -top-24 h-56 w-56 rounded-full bg-(--secondary)/30 blur-3xl" />
              <div className="absolute -left-16 -bottom-24 h-48 w-48 rounded-full bg-(--primary)/15 blur-3xl" />
              ...
              <div className="relative p-6 sm:p-8 flex flex-col h-full justify-between pb-8">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <h3 className="text-lg sm:text-xl font-semibold text-(--deep)">
                        {activeStep.title}
                      </h3>
                    </div>
                  </div>

                  <p className="text-sm sm:text-base text-(--deep)/80">
                    {activeStep.description}
                  </p>

                  <div className="mt-6 rounded-2xl bg-(--primary)/5 px-4 py-3 text-xs sm:text-sm text-(--primary)">
                ...
                <div className="mt-auto pt-6 flex flex-wrap items-center gap-3 text-[11px] text-(--deep)/60">
                  <span className="rounded-full bg-(--secondary)/20 px-3 py-1 font-semibold uppercase tracking-[0.18em] text-(--primary)">
          ...
          <div className="lg:w-2/5">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center rounded-2xl border px-2 py-3 text-xs transition hover:cursor-pointer ${
                      isActive
                        ...
                        : "border-(--primary)/15 bg-white/70 text-(--deep)/70 hover:bg-white"
                    }`}
                  >
                    <span
            ...
            <div className="mt-4 flex items-center justify-between gap-2 text-xs">
              <button
                type="button"
                onClick={goPrev}
                className="rounded-full border border-(--primary)/30 px-4 py-2 font-semibold uppercase tracking-[0.16em] text-(--primary) bg-white hover:bg-gray-100 transition hover:cursor-pointer"
              >
                Anterior
              </button>
              ...
              <button
                type="button"
                onClick={goNext}
                className="rounded-full bg-(--primary) px-4 py-2 font-semibold uppercase tracking-[0.16em] text-white hover:bg-(--primaryDark) transition hover:cursor-pointer"
              >
                Seguinte
              </button>
            </div>
